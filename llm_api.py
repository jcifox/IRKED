...
class DomesticLLMClient:
    """
    国内大模型统一客户端
    支持 deepseek / qianwen / kimi / xinghuo / glm
    """
    ...
    ENDPOINTS = {
        ...
        "kimi": "https://ark.cn-beijing.volces.com/api/v3/chat/completions",
        "xinghuo": "https://spark-api-open.xf-yun.com/v2/chat/completions",
    ...
    def _format_request(self, prompt: str, system_prompt: Optional[str] = None) -> Dict:
        ...
        return {
            ...
            "temperature": 0.7,
            "max_tokens": 2048,
            "model": self.MODEL_CODES[self.model_name],
        }
    ...
    def generate(self, prompt: str,
        ...
        for i in range(retry):
            try:
                ...
                if self.model_name in ("deepseek", "qianwen", "glm", "xinghuo", "kimi"):
...
if __name__ == "__main__":
    ...
    print(client.generate("用一句话介绍Kimi大模型"))